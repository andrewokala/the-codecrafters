...
Typed Constants: are declared with the type. e.g `const A int = 1`
Untyped Constants: are declared without a type. e.g `const A = 1` Note: in this case, the type is inferred from the value
